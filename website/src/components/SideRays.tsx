// SideRays from React Bits (reactbits.dev), adapted for this site: the
// Tailwind utility classes on the container were replaced with inline styles
// (the site doesn't use Tailwind); the WebGL shader is untouched.
